...
export default class OpportunityPath extends NavigationMixin(LightningElement)  {
    ...
    @wire(getPicklistValues, { recordTypeId: '$opportunity.data.defaultRecordTypeId', fieldApiName: STAGE_NAME_FIELD })
    status({data, error}){
        console.log('data stages', data);
        console.log('error stages', error);
        if ( data ) {
            ...
            getMessagesHover({
                ...
                .then(result => {
                    console.log('result stages', result);
    ...
    statusSelected (evt) {
        ...
        this.hasInfoKeyFieldsOrGuidance ();
